...
| Celestial Flight Deck | `pnpm demo:showcase` | A machine-backed tour of all 17 public packages and 47 curated builders, with Rosetta locale/bidi tools, deep Orbit and rich-output instruments, layered controls, context menus, and workspace-aware Horizon windows, shelf, snapping, tiling, and sessions |
