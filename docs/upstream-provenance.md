...
- Constellation is published as `@celestial/ui` with a curated 46-builder barrel. Imported modal and contextual surfaces were updated to reflow on resize and retain visible close controls plus Escape dismissal; context-menu composition helpers remain public without being counted as builders.
